...
foolqq在中国电信、中国联通的省公司、科大国创公司内部都有应用，包括工单自动处理、群里常见问题答复、定时告警推送等丰富应用，当然这其中涉及NLP的部分不在本文讨论的范畴。



# 设计不足

foolqq面向桌面的会话窗口，对一台电脑而言，桌面最多可以放下8个群，此外如果你有多个业务qq号操作不同的业务，则需要虚拟不同的桌面。
